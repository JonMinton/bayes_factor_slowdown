...
```{r, echo = FALSE}
pacman::p_load(tidyverse, here, changepoint, segmented, ggrepel, knitr, kableExtra, HMDHFDplus, corrr)
...
```{r get_e0_hmd, echo = FALSE, cache = TRUE}
hmd_e0 <- tibble(
...
```{r fn_clean_data, echo = FALSE, eval = FALSE}
...
```{r fn_get_mx_data, echo = FALSE, eval = FALSE}
