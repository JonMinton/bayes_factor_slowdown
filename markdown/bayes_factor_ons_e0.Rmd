...
wb %>% addWorksheet(sheetName = "hmd_countries_decade")
wb %>% writeData(sheet = "hmd_countries_decade", x = wide_table, startRow = 2)
wb %>% mergeCells(sheet = "hmd_countries_decade", rows = 1, cols = 2:5)
wb %>% mergeCells(sheet = "hmd_countries_decade", rows = 1, cols = 6:9)
wb %>% writeData(sheet = "hmd_countries_decade", x = make_fake_mtrx(c(" ",rep("Female", 4), rep("Male", 4))))
wb %>% addStyle(sheet = "hmd_countries_decade", rows = 1, cols = 1:9, 
                style = createStyle(textDecoration = "bold", halign = "center")
  )
wb %>% addStyle(sheet = "hmd_countries_decade", rows = 2, cols = 1:9, 
                style = createStyle(border = "bottom")
  )
wb %>% addStyle(sheet = "hmd_countries_decade", rows = 3:39, cols = 2:9, gridExpand = TRUE, 
                style = createStyle(numFmt = "0.000")
  )
wb %>% setColWidths(sheet = "hmd_countries_decade", cols = 1, widths = "auto"
  )
wb %>% addStyle(sheet = "hmd_countries_decade", rows = 2:39, cols = 2, stack = TRUE,
                style = createStyle(border = "left")
  )



saveWorkbook(wb, file = here("bayes_paper", "tables", "M01_hmd_countries_decade.xlsx"), overwrite = TRUE)
...
Let's save the full lifeables (as they're useful for another project!) 

```{r}
ons_lifetables %>% 
  write_rds(here("data", "all_ons_lifetables_tidied.rds"))
...
wb <- openxlsx::createWorkbook()
wb %>% addWorksheet(sheetName = "ons_countries_decade")
wb %>% writeData(sheet = "ons_countries_decade", x = wide_table, startRow = 2)
wb %>% mergeCells(sheet = "ons_countries_decade", rows = 1, cols = 2:5)
wb %>% mergeCells(sheet = "ons_countries_decade", rows = 1, cols = 6:9)
wb %>% writeData(sheet = "ons_countries_decade", x = make_fake_mtrx(c(" ",rep("Female", 4), rep("Male", 4))))
wb %>% addStyle(sheet = "ons_countries_decade", rows = 1, cols = 1:9, 
                style = createStyle(textDecoration = "bold", halign = "center")
  )
wb %>% addStyle(sheet = "ons_countries_decade", rows = 2, cols = 1:9, 
                style = createStyle(border = "bottom")
  )
wb %>% addStyle(sheet = "ons_countries_decade", rows = 3:7, cols = 2:9, gridExpand = TRUE, 
                style = createStyle(numFmt = "0.000")
  )
wb %>% setColWidths(sheet = "ons_countries_decade", cols = 1, widths = "auto"
  )
wb %>% addStyle(sheet = "ons_countries_decade", rows = 2:7, cols = 2, stack = TRUE,
                style = createStyle(border = "left")
  )



saveWorkbook(wb, file = here("bayes_paper", "tables", "M02_ons_countries_decade.xlsx"), overwrite = TRUE)
...
Let's produce the above properly (rather than copying values) and save to an excel workbook
...
wb <- openxlsx::createWorkbook()
wb %>% addWorksheet(sheetName = "ons_hmd_comparison_decade")
wb %>% writeData(sheet = "ons_hmd_comparison_decade", x = ons_hmd_comparison_decade %>% set_names(., nm = c(" ", " ", "HMD", "ONS")), startRow = 2)
wb %>% mergeCells(sheet = "ons_hmd_comparison_decade", rows = 1, cols = 3:4)
wb %>% writeData(sheet = "ons_hmd_comparison_decade", x = make_fake_mtrx(c("Sex", "Decade", rep("Average annual gain", 2))))
wb %>% addStyle(sheet = "ons_hmd_comparison_decade", rows = 1:2, cols = 1:4, gridExpand = TRUE, stack = TRUE,
                style = createStyle(textDecoration = "bold", halign = "center")
  )
wb %>% addStyle(sheet = "ons_hmd_comparison_decade", rows = 3:10, cols = 3:4, gridExpand = TRUE, stack = TRUE,
                style = createStyle(numFmt = "0.000")
  )
wb %>% addStyle(sheet = "ons_hmd_comparison_decade", rows = 1:10, cols = 3, gridExpand = TRUE, stack = TRUE,
                style = createStyle(border = "left")
  )
wb %>% addStyle(sheet = "ons_hmd_comparison_decade", rows = 2, cols = 1:4, gridExpand = TRUE, stack = TRUE,
                style = createStyle(border = "bottom")
  )


# wb %>% addStyle(sheet = "ons_proj_improvements_sd", rows = 2, cols = 1:9, 
#                 style = createStyle(border = "bottom")
#   )
# wb %>% setColWidths(sheet = "ons_proj_improvements_sd", cols = 1:9, widths = "auto"
#   )
# wb %>% addStyle(sheet = "ons_proj_improvements_sd", rows = 2:7, cols = 2, stack = TRUE,
#                 style = createStyle(border = "left")
#   )
# 


saveWorkbook(wb, file = here("bayes_paper", "tables", "A01_ons_hmd_decade.xlsx"), overwrite = TRUE)
...
```{r}
wb <- createWorkbook()
wb %>% addWorksheet(sheetName = "ons_trend_correlation")
wb %>% writeData(sheet = "ons_trend_correlation", x = corrs_trends %>% rename(` ` = rowname), startRow = 1)
# wb %>% mergeCells(sheet = "ons_hmd_comparison_decade", rows = 1, cols = 3:4)
# wb %>% writeData(sheet = "ons_hmd_comparison_decade", x = make_fake_mtrx(c("Sex", "Decade", rep("Average annual gain", 2))))
wb %>% addStyle(sheet = "ons_trend_correlation", rows = 1, cols = 1:9, gridExpand = TRUE, stack = TRUE,
                 style = createStyle(textDecoration = "bold", halign = "center", textRotation = 70)
   )
wb %>% addStyle(sheet = "ons_trend_correlation", rows = 1:9, cols = 1, gridExpand = TRUE, stack = TRUE,
                 style = createStyle(textDecoration = "bold", valign = "center")
   )

wb %>% addStyle(sheet = "ons_trend_correlation", rows = 2:9, cols = 2:9, gridExpand = TRUE, stack = TRUE,
                style = createStyle(numFmt = "0.000")
  )
wb %>% setRowHeights(sheet = "ons_trend_correlation", rows = 2:9, heights = 20)
wb %>% setColWidths(sheet = "ons_trend_correlation", cols = 2:9, widths = 5)
wb %>% setColWidths(sheet = "ons_trend_correlation", cols = 1, widths = "auto")
...
wb %>% saveWorkbook(file = here("bayes_paper", "tables", "A02_corrs_trends_uk.xlsx"), overwrite = TRUE)
...
* *Note*: For some reason this currently doesn't run on my own computer, but does on the work version. (This is likely to be due to difference in package and R version. For now I can live with this.
...
wide_table <-
 ...
 wb <- openxlsx::createWorkbook()
 wb %>% addWorksheet(sheetName = "uk_breakpoint")
 wb %>% writeData(sheet = "uk_breakpoint", x = wide_table, startRow = 1)
 wb %>% addStyle(sheet = "uk_breakpoint", rows = 1, cols = 1:6, 
                 style = createStyle(textDecoration = "bold")
   )
wb %>% addStyle(sheet = "uk_breakpoint", rows = 1, cols = 1:6, stack = TRUE,
                style = createStyle(border = "bottom")
  )
wb %>% addStyle(sheet = "uk_breakpoint", rows = 1:11, cols = 3, stack = TRUE,
                style = createStyle(border = "left")
  )
wb %>% addStyle(sheet = "uk_breakpoint", rows = 2:11, cols = 3:6, gridExpand = TRUE, stack = TRUE,
                style = createStyle(numFmt = "0.00")
  )
 wb %>% setColWidths(sheet = "uk_breakpoint", cols = 1:6, widths = "auto"
   )
# 
 saveWorkbook(wb, file = here("bayes_paper", "tables", "uk_breakpoint.xlsx"), overwrite = TRUE)
...
There was a report showing how pre 2012 ONS projections compared. Let's get the data and visualise too. 

The underlying data is available [here](https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationprojections/adhocs/006372nationalpopulationprojectionsaccuracyreportunderlyingdatauk1966to2030), and the link to the excel file itself is [here](https://www.ons.gov.uk/file?uri=/peoplepopulationandcommunity/populationandmigration/populationprojections/adhocs/006372nationalpopulationprojectionsaccuracyreportunderlyingdatauk1966to2030/eolsforfigures12and13nppaccuracyreport.xls). 

Let's download this file to a sensible place 

```{r, echo = TRUE, eval = FALSE}
download.file(
  url = "https://www.ons.gov.uk/file?uri=/peoplepopulationandcommunity/populationandmigration/populationprojections/adhocs/006372nationalpopulationprojectionsaccuracyreportunderlyingdatauk1966to2030/eolsforfigures12and13nppaccuracyreport.xls",
  destfile = here("data", "ons_projections", "historic_comparison.xls"),
  mode = "wb"
)
...
ggsave(here("bayes_paper", "figures", "M02_ons_lt_projns.png"), height = 20, width = 25, units = "cm", dpi = 300)
```
...
wb <- openxlsx::createWorkbook()
wb %>% addWorksheet(sheetName = "ons_proj_improvements_sd")
wb %>% writeData(sheet = "ons_proj_improvements_sd", x = table_wide, startRow = 2)
wb %>% mergeCells(sheet = "ons_proj_improvements_sd", rows = 1, cols = 2:5)
wb %>% mergeCells(sheet = "ons_proj_improvements_sd", rows = 1, cols = 6:9)
wb %>% writeData(sheet = "ons_proj_improvements_sd", x = make_fake_mtrx(c(" ",rep("Female", 4), rep("Male", 4))))
wb %>% addStyle(sheet = "ons_proj_improvements_sd", rows = 1, cols = 1:9, 
                style = createStyle(textDecoration = "bold", halign = "center")
  )
wb %>% addStyle(sheet = "ons_proj_improvements_sd", rows = 2, cols = 1:9, 
                style = createStyle(border = "bottom")
...
saveWorkbook(wb, file = here("bayes_paper", "tables", "M03_ons_proj_improvements_sd.xlsx"), overwrite = TRUE)
...
As a table for Excel (sd instead of var)
...
```{r}
wb <- createWorkbook()
wb %>% addWorksheet(sheetName = "ons_avg_gain_1991_2010")

wb %>% writeData(sheet = "ons_avg_gain_1991_2010", table_1991_2010_gains %>% set_names(., nm = c("Country", "Sex", "Mean gain", "SD")))

wb %>% addStyle(sheet = "ons_avg_gain_1991_2010", rows = 1, cols = 1:4, stack = TRUE,
                         style = createStyle(textDecoration = "bold", halign = "center")
)
wb %>% addStyle(sheet = "ons_avg_gain_1991_2010", rows = 2:11, cols = 3:4, stack = TRUE, gridExpand = TRUE,
                         style = createStyle(numFmt = "0.000")
)
wb %>% addStyle(sheet = "ons_avg_gain_1991_2010", rows = 1, cols = 1:4, stack = TRUE, gridExpand = TRUE,
                         style = createStyle(border = "bottom")
)
wb %>% addStyle(sheet = "ons_avg_gain_1991_2010", rows = 1:11, cols = 3, stack = TRUE, gridExpand = TRUE,
                         style = createStyle(border = "left")
)

wb %>% setColWidths(sheet = "ons_avg_gain_1991_2010", cols = 1:4, widths = "auto") 


saveWorkbook(wb, file = here("bayes_paper", "tables", "A04_avg_gain_uknations_1991_2010.xlsx"), overwrite = TRUE)
...
wb <- openxlsx::createWorkbook()
wb %>% addWorksheet(sheetName = "bf_nochange")
wb %>% writeData(sheet = "bf_nochange", x = table_wide, startRow = 1)
# wb %>% mergeCells(sheet = "ons_proj_improvements_sd", rows = 1, cols = 2:5)
# wb %>% mergeCells(sheet = "ons_proj_improvements_sd", rows = 1, cols = 6:9)
# wb %>% writeData(sheet = "ons_proj_improvements_sd", x = make_fake_mtrx(c(" ",rep("Female", 4), rep("Male", 4))))
 wb %>% addStyle(sheet = "bf_nochange", rows = 1, cols = 1:9, 
                 style = createStyle(textDecoration = "bold", halign = "center")
   )
wb %>% addStyle(sheet = "bf_nochange", rows = 1, cols = 1:9, stack = TRUE, 
                style = createStyle(border = "bottom")
  )
 wb %>% setColWidths(sheet = "bf_nochange", cols = 1:9, widths = "auto"
   )
# wb %>% addStyle(sheet = "ons_proj_improvements_sd", rows = 2:7, cols = 2, stack = TRUE,
#                 style = createStyle(border = "left")
#   )
...
saveWorkbook(wb, file = here("bayes_paper", "tables", "M04_bf_nochange.xlsx"), overwrite = TRUE)
...
wb <- openxlsx::createWorkbook()
wb %>% addWorksheet(sheetName = "bf_cf_ons")
wb %>% writeData(sheet = "bf_cf_ons", x = combined_table_wide %>% set_names(nm = c("", "", "Bayes", "ONS", "Bayes", "ONS")), startRow = 2)
wb %>% writeData(sheet = "bf_cf_ons", x = make_fake_mtrx(c("Population", "Year",rep("Female", 2), rep("Male", 2))))

wb %>% mergeCells(sheet = "bf_cf_ons", rows = 1, cols = 3:4)
wb %>% mergeCells(sheet = "bf_cf_ons", rows = 1, cols = 5:6)

wb %>% addStyle(sheet = "bf_cf_ons", rows = 1:2, cols = 1:6, gridExpand = TRUE, 
                 style = createStyle(textDecoration = "bold", halign = "center")
   )
wb %>% addStyle(sheet = "bf_cf_ons", rows = 2:42, cols = 3:6, gridExpand = TRUE, stack = TRUE,
                 style = createStyle(numFmt = "0.000"))
wb %>% addStyle(sheet = "bf_cf_ons", rows = 2, cols = 1:9, stack = TRUE,
                style = createStyle(border = "bottom")
  )
 wb %>% setColWidths(sheet = "bf_cf_ons", cols = 1:6, widths = "auto"
   )
wb %>% addStyle(sheet = "ons_proj_improvements_sd", rows = 1:42, cols = 3, stack = TRUE,
                style = createStyle(border = "left")
  )



saveWorkbook(wb, file = here("bayes_paper", "tables", "M05_bf_cf_ons_projections.xlsx"), overwrite = TRUE)
...
Now a figure just for UK as a whole 
