...
saveWorkbook(wb, file = here("bayes_paper", "tables", "hmd_countries_decade.xlsx"), overwrite = TRUE)
...
saveWorkbook(wb, file = here("bayes_paper", "tables", "ons_countries_decade.xlsx"), overwrite = TRUE)
...
ggsave(here("bayes_paper", "figures", "R3A01_Randomnumberseed.png"), height = 10, width = 15, units = "cm", dpi = 300)
```
...
ggsave(here("bayes_paper", "figures", "R4_01_projections1971_2018.png"), height = 15, width = 20, units = "cm", dpi = 300)
```
...
ggsave(here("bayes_paper", "figures", "R4A01_ons_life_expectancy_projections.png"), height = 25, width = 25, units = "cm", dpi = 300)
...
ons_projections_tidied %>%
  ...
  labs(
    x= "Year", y = "Age in years", 
    title = "Females, Projected life expectancy by ONS projection year and country"
  )
...
ons_projections_tidied %>% 
  ...
  labs(
    ...
    title = "Males, change in conditional life expectancy projection"
  ) +
...
ons_projections_tidied %>% 
  ...
  labs(
    x = "Year", y = "Age in years", fill = "Change in ex",
    title = "Females, change in conditional life expectancy projection"
  ) +
  theme(axis.text.x = element_text(angle = 90))
...
saveWorkbook(wb, file = here("bayes_paper", "tables", "ons_proj_improvements_sd.xlsx"), overwrite = TRUE)
...
table_wide <- 
  bf_mutexc %>% 
    ...
    select(population, sex, period, perc, bayes_factor) %>% 
...
saveWorkbook(wb, file = here("bayes_paper", "tables", "bf_nochange.xlsx"), overwrite = TRUE)
...
saveWorkbook(wb, file = here("bayes_paper", "tables", "bf_cf_ons_projections.xlsx"), overwrite = TRUE)
...
ggsave(here("bayes_paper","figures", "ons_cf_bayes.png"), height = 12, width = 20, units = "cm", dpi = 300)
