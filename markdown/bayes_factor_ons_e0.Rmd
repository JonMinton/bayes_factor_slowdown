...
ggsave(here("figures", "annual_e0_ch_all_DISTINCT_uknations_ons_overlaid.png"), height = 15, width = 25, units = "cm", dpi = 300)
...
* Download all of the above and load and tidy them


```{r download_proj_uk, eval = FALSE}
...
```{r download_proj_wales, eval = FALSE}
...
```{r download_proj_northernireland, eval = FALSE}
...
ons_projections_tidied %>% 
  ...
  ggplot(aes(x = year, y = ex, group = factor(proj_year), colour = factor(proj_year))) + 
