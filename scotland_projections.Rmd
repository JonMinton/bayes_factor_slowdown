...
ons_lifetables <- 
  ons_lifetables %>% 
    mutate(mx_data = map(file_location, ~.x %>% paste0("data/", .) %>% get_mx_data())) %>% 
...
write_csv(ons_e0, "data/e0_from_ons_allnations.csv")
```
...
ggsave("figures/allnations_ons_projections.png", height = 15, width = 25, units = "cm", dpi = 300)
...
ggsave("figures/allnations_ons_projections_longer.png", height = 15, width = 25, units = "cm", dpi = 300)
...
ggsave("figures/allnations_ons_10yeartargets.png", height = 15, width = 25, units = "cm", dpi = 300)
...
allnations_next_decade_targets %>% 
  ...
  ungroup() %>% 
  write_csv("data/predictions_to_2028.csv")
...
ggsave("figures/allnations_projected_observed.png",height = 15, width = 20, units = "cm", dpi = 300)
